...
function InitStarTrekOverlay(pageContainerElement, logoImageSrc, warpDurationMilliseconds){
    ...
    // initialize
    document.body.className += " StarTrekWarpJumpBody";
    ...
    var renderCallback = function(timestamp)
    {
        ...
        g.lineWidth = 2;
        g.beginPath();
        g.moveTo(width - (xpadding + xsize), xpadding);
        g.lineTo(width - xpadding, (xpadding + xsize));
        g.stroke();
        g.beginPath();
        g.moveTo(width - xpadding, xpadding);
        g.lineTo(width - (xpadding + xsize), xpadding + xsize);
        g.stroke();
    ...
    function close(){
        if (!closing){
            ...
            document.body.className = document.body.className.replace(" StarTrekWarpJumpBody", "");
